...
This document defines the scoring criteria for all events. These criteria are implemented in the application and used by judges for evaluation.
...
## How Scoring Works in the Application
...
4. **Validation**: Application prevents entering scores above maximum
...
- Judges can only score their assigned events
...
A: Yes, the application supports decimal scoring if needed.

**Q: What if I make a mistake?**
A: Contact the admin immediately. Admin can unlock and allow re-scoring.

**Q: Can I see other judges' scores?**
A: No, judges only see their own event. Display screen shows final totals.
...
- Judge Login: Verify PIN and event assignment
- Display Not Updating: Refresh browser, check internet connection
